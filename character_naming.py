...
rolled = ["Arim", "Candy", "Daum", "Hyori", "Dahen", "Pan-yi", "Min-ji",
          "Jiin", "Anna"]

jpop = ["Ayumi", "Hikaru", "Mao", "Atsuko", "Yuuko", "Lisa", "Ruiha",
        "Hitomi", "Regina", "Kia", "Kanna", "An"]

kpop = ["Lisa", "Jeannie", "Rosie", "Taeyeon", "Eunjung", "Hyomin"]

other_characters_m = ["Malthael", "Calistarius",
                      "Rakthar the Barbarian", "Final", "FinalStryke",
                      "Gerdfuhr"]

other_characters_f = ["Eashuel"]

friends_characters_m = ["Agrath", "Fucking Agrath", "Jolmaer",
                        "Jolmy Jolm", "Dwayne", "Perrin Murksorrow",
...
friends_character_f = ["Tira", "Cora", "Allin", "Maki", "Lura Ruutag",
...
misc_m = ["Fukumaru", "Maron", "Bruiser", "Lucky", "Pookoo", "Abaddon",
          ...
          "Michael Motherfucking McDonald", "Angelo", "Alexander",
